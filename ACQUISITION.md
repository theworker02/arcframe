...
<img src="assets/arcframe-readme.svg" alt="Arcframe" width="420" /> <p align="center"><strong>The engineering control plane for Cursor</strong></p> Local-first repository intelligence for Cursor MCP and AI coding agents.<br />

**Why a buyer cares:** or packages transferable product IP â€” source, docs, in-repo brand assets, and a diligence room under `docs/acquisition/` â€” under a clear proprietary posture so diligence can proceed without mistaking the repo for open source.
...
Teams evaluating or typically need either (a) a commercial right to run or embed it, or (b) outright ownership of the Product IP for strategic build-out. Public GitHub visibility without a proprietary license creates false assumptions about free production use. This brief and the linked data room make the commercial path explicit.
